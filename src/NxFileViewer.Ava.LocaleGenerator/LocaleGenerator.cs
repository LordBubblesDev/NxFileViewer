...
namespace NxFileViewer.Ava.LocaleGenerator;
...
public class LocaleGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(contents, (spc, content) => {
            ...
            enumSourceBuilder.AppendLine("namespace NxFileViewer.Ava.Localization;\n");
            enumSourceBuilder.AppendLine("public enum FvLocale");
            ...
            spc.AddSource("NxFileViewer.Ava.Localization.FvLocale.g.cs", enumSourceBuilder.ToString());
        });
    }
