...
public class FoundEntry(IFileSystem sectionFileSystem, DirectoryEntryEx entry)
{
    public IFileSystem SectionFileSystem { get; } = sectionFileSystem;

    public DirectoryEntryEx Entry { get; } = entry;
