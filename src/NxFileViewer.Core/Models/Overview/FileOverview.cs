...
public class FileOverview : NotifyPropertyChangedBase
{
    ...
    private NcasIntegrity _signatureIntegrity = NcasIntegrity.Unchecked;
    private NcasIntegrity _hashIntegrity = NcasIntegrity.Unchecked;
    ...
    private IItem RootItem { get; }

    public bool IsSuperPackage => CnmtContainers.Count > 1;

    private NxBaseFileType BaseFileType => _basePackageType ??= DetermineBasePackageType();
    ...
    public NcasIntegrity SignatureIntegrity
    {
        get => _signatureIntegrity;
        set
        {
            _signatureIntegrity = value;
            NotifyPropertyChanged();
        }
    }

    public NcasIntegrity HashIntegrity
    {
        get => _hashIntegrity;
        set
        {
            _hashIntegrity = value;
            NotifyPropertyChanged();
        }
    }
